# 定義網頁邏輯 (View) ，決定如何處理 request 並回應。
...
def home(request):
    return render(request, 'app_top_keyword/top_keyword.html')


# read df
df_topkey = pd.read_csv(
    'app_top_keyword/dataset/cna_news_topkey_with_category_via_token_pos.csv', sep=',')
...
print("app_top_keyword--類別熱門關鍵字載入成功!")
